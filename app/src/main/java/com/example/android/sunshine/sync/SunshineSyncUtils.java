...
//  TODO (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SYNC_PERIOD_HOURS = 3;
    private static final int SYNC_PERIOD_SECS = (int) TimeUnit.HOURS.toSeconds(SYNC_PERIOD_HOURS);
     static final int SYNC_FLEXTIME_SECS = SYNC_PERIOD_SECS;
    ...
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context){
        ...
        Job syncSunshineJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(
                        SYNC_PERIOD_SECS,
                        SYNC_PERIOD_SECS + SYNC_FLEXTIME_SECS))
