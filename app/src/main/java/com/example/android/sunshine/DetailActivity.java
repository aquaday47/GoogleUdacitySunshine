...
//      TODO (7) Display the weather icon using mDetailBinding
        ...
        int weatherIconId = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        mDetailBinding.primaryInfo.iconDetails.setImageResource(weatherIconId);
...
//      TODO (9) Use mDetailBinding to display the description and set the content description
        ...
        mDetailBinding.primaryInfo.descDetails.setText(description);

//      TODO (8) Use mDetailBinding to display the date
        long localDateMidnightGmt = data.getLong(INDEX_WEATHER_DATE);
        String dateText = SunshineDateUtils.getFriendlyDateString(this, localDateMidnightGmt, true);
        mDetailBinding.primaryInfo.dateDetails.setText(dateText);
...
//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryInfo.iconDetails.setContentDescription(getString(R.string.a11y_forecast, description));
        /**************************
...
//      TODO (17) Create the content description for the high temperature for a11y
        mDetailBinding.primaryInfo.hiTDetails.setContentDescription(getString(R.string.a11y_high_temp, highString));
...
//      TODO (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDetailBinding.primaryInfo.hiTDetails.setText(highString);
...
//      TODO (18) Create the content description for the low temperature for a11y
        mDetailBinding.primaryInfo.loTDetails.setContentDescription(getString(R.string.a11y_low_temp, lowString));
//      TODO (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDetailBinding.primaryInfo.loTDetails.setText(lowString);
        /************
         * Humidity *
         ************/
...
//      TODO (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDetailBinding.extraDetails.humidityValExtra.setText(humidityString);
...
//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraDetails.humidityLabelExtra.setContentDescription(getString(R.string.a11y_humidity, humidityString));
        /****************************
...
//      TODO (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDetailBinding.extraDetails.windValExtra.setText(windString);
...
//      TODO (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraDetails.windLabelExtra.setContentDescription(getString(R.string.a11y_wind, windString));
        /************
         * Pressure *
         ************/
...
//      TODO (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDetailBinding.extraDetails.pressureValExtra.setText(pressureString);
...
//      TODO (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraDetails.pressureLabelExtra.setContentDescription(getString(R.string.a11y_pressure, pressureString));
