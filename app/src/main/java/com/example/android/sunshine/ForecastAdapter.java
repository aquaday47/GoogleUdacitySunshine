...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public interface ForecastAdapterOnClickHandler {void onListItemClick(String clickedItemIndex);}
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View v) {
            ...
            int posOfClick = getAdapterPosition();
            //String dayWeather = mWeatherData[posOfClick];
            //accessing the day's weather data how?
            mClickHandler.onListItemClick(String.valueOf(posOfClick));
            //mClickHandler.onListItemClick(String.valueOf(posOfClick)) = mWeatherData[posOfClick];
        }
    }
