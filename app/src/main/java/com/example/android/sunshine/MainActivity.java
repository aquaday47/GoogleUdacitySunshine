...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final String WEATHER_DATA_KEY = "Search Query";
    private static final int LOADER_ID_NO = 47;
    ...
    private void loadWeatherData() {
        ...
        //Should this be bundling location? or the resultsOfQuery
        queryBundle.putString(WEATHER_DATA_KEY, location);

        LoaderManager lm = getSupportLoaderManager();
        Loader<String[]> weatherResultsLoader = lm.getLoader(LOADER_ID_NO);
        if (weatherResultsLoader == null){
            lm.initLoader(LOADER_ID_NO,queryBundle, this);

        } else{
            lm.restartLoader(LOADER_ID_NO, queryBundle, this);
        }
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                String location = args.getString(WEATHER_DATA_KEY);
