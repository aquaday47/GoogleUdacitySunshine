...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // View gets a reference to the weather forecast RecyclerView
        ...
        //alternatively, new LinearLayoutManageer(this, LinearLayoutManager.VERTICAL, false);

        // TODO (39) Set the layoutManager on mRecyclerView // layoutManager.setRecycleChildrenOnDetach(true);
